...
DATABASE_NAME = 'peoplemigrateask'             # Or path to database file if using sqlite3.
DATABASE_USER = 'blannon'             # Not used with sqlite3.
DATABASE_PASSWORD = 'cuibono'         # Not used with sqlite3.
...
DOMAIN_NAME = 'peoplemigrate.org'

CSRF_COOKIE_NAME = 'peoplemigrate.org_csrf'
